...
Load the CNV regions from sampleInputCNV.rda, and plot the distribution of the CNV regions.
...
Check the amount of genes without pHI scores, then find the corresponding pHI scores.
